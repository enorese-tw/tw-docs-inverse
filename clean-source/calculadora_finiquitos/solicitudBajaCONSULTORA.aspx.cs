...
{
    public partial class solicitudBajaCONSULTORA : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (TextBox1.Text != "")
                {
                    ...
                    foreach (DataRow rows in softland.GetRutTrabajadorSolicitudBajaCONSULTORAService.Tables[0].Rows)
                    {
