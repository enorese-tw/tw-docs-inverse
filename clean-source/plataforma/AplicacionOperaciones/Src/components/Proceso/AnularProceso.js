...
const RenderAnularProceso = (dataset) => {

    const { codigosolicitud, type, functionrechazo, name } = dataset;
        ...
        <div style="width: 90%;" class="m-auto">
            ...
            <div class="pdb-30 pdt-30 ta-center">
                <button class="btn btn-success color-fx3 new-family-teamwork pdt-10 pdl-20 pdr-20 pdb-10" style="font-weight: 100; border: none; border-radius: 50px;"
                        data-solicitud="${codigosolicitud}" data-type="${type}" data-input="obs__rechazo" onclick="${functionrechazo}(this)">
                    Confirmar Anulación
                </button>
