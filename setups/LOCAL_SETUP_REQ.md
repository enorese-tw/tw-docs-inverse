...
El proyecto se conecta a dos servidores de base de datos SQL Server distintos. Las credenciales y nombres de base de datos están encriptados en Base64 en el `Web.config`.
